...
def create(params, **data):
  ...
  parameters:
    - params:
      ...
      --n;d;[BLACK:0,WHITE:1,RED:2,GREEN:3, BLUE:4,MAGENTA:5,CYAN:6,YELLOW:7,LIME:8];BLACK-- fcolor: QR code fill color
      --n;d;[BLACK:0,WHITE:1,RED:2,GREEN:3, BLUE:4,MAGENTA:5,CYAN:6,YELLOW:7,LIME:8];WHITE-- bcolor: QR code background color
      --b;f;[False,True];False-- style: QR code styling - block shape, gradient
  ...
  qr_data = data.get('qr-data', 'Some data')
  ...
  if style:
    ...
    qr_img_pil = qr.make_image(back_color=colors[back_color], fill_color=colors[fill_color])
