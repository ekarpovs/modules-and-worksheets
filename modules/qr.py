...
def create(params, **data):
  ...
  parameters:
    - params:
      --n;r;[1,40,1];3-- version: controls size of QR (smallest - 21*21)
      --n;r;[1,20,1];10-- box-size: number of pix for each block of QR
      ...
      --n;d;[BLACK:0,WHITE:1,RED:2,GREEN:3, BLUE:4];BLACK-- fcolor: 
      --n;d;[BLACK:0,WHITE:1,RED:2,GREEN:3, BLUE:4];WHITE-- bcolor: 
      # --b;f;[False,True];False-- style: styled QR code
      # --n;d;[SQUARE:0,ROUND:1,CIRCLE:2];SQUARE-- drower: shape of the QR code blocks
      # --n;d;[RADIAL:0,SQUARE:1,HORIZONTAL:2,VERTICAL:3,IMAGE:4];RADIAL-- gradient: gradient or embedded image
    - data: 
  ...
  box_size = params.get('box-size', 10)
  ...
  drowers = [SquareModuleDrawer, RoundedModuleDrawer, CircleModuleDrawer]
  masks = [
  ...
  qr_img_pil = qr.make_image(back_color=colors[back_color], fill_color=colors[fill_color], image_factory=factory, module_drawer=module_drower)
